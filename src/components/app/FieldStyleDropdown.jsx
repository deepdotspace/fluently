...
function FieldStyleDropdown({
  ...
  const handleStyleSelect = (styleType, value) => {
    ...
    console.log(`[handleStyleSelect] ${styleType}:`, value);
    console.log('  Old style:', oldStyle);
    console.log('  New style:', newStyle);
    console.log('  Keys preserved:', Object.keys(newStyle));
  ...
  const handleSpecialColorSelect = (color) => {
  ...
  const handleFontSelect = (fontFamily) => {
    console.log('[handleFontSelect] Received:', fontFamily, 'Type:', typeof fontFamily);
  ...
  // Debug: Track render count to detect infinite loops (only log first 10 renders)
  const renderCountRef = useRef(0);
  renderCountRef.current += 1;

  if (renderCountRef.current <= 10) {
    console.log(`[FieldStyleDropdown] Render #${renderCountRef.current}`, {
      fieldName: field.name,
      styleKeys: Object.keys(currentStyle),
      fontFamily: currentStyle.fontFamily
    });
  } else if (renderCountRef.current === 11) {
    console.log('[FieldStyleDropdown] Render count exceeded 10 - stopping logs to prevent spam');
  }
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
              <input
                ...
                onChange={(e) => setCustomSpecialColor(e.target.value)}
                style={{
                  width: '32px',
                  height: '32px',
                  border: 'none',
