...
function CardTypeSelector({
  ...
  const selectedCardType = cardTypes?.[selectedCardTypeId] || cardTypesList[0];
    ...
    <div ref={dropdownRef} style={{ position: 'relative', width: '100%' }}>
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
        ...
        <button
          ...
          onMouseLeave={(e) => {
            if (!isOpen) {
              e.target.style.borderColor = theme?.cardBorder || '#e5e7eb';
            }
          }}
        >
        ...
        {onEditClick && !isMobile && (
          <button
            ...
            onMouseEnter={(e) => {
              e.target.style.background = theme?.primary || '#3b82f6';
              e.target.style.color = 'white';
            }}
            onMouseLeave={(e) => {
              e.target.style.background = 'rgba(255, 255, 255, 0.6)';
              e.target.style.color = theme?.textPrimary || '#1f2937';
            }}
          >
                ...
                >
                  ...
                  {!isDefault && onEditCardType && !isMobile && (
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.target.style.background = 'transparent';
                        e.target.style.color = theme?.textSecondary || '#6b7280';
                        e.target.style.borderColor = theme?.cardBorder || '#e5e7eb';
                      }}
                    >
