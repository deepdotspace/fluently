...
function CreateCardForm({
  ...
  const handleFieldChange = useCallback((fieldName, value) => {
    console.log('🔄 [CreateCardForm] Field change:', fieldName, 'New value:', value);
    setFieldValues(prev => {
      const newValues = {
        ...prev,
        [fieldName]: value
      };
      console.log('🔄 [CreateCardForm] Updated fieldValues:', newValues);
      return newValues;
    });
  }, []);
  ...
  const handleFieldMediaGenerated = useCallback((fieldName, mediaData) => {
    console.log('🎨 [CreateCardForm] Media generated for field:', fieldName, 'Type:', mediaData.type, 'URL:', mediaData.url);
    setFieldMedia(prev => {
      ...
      console.log('🎨 [CreateCardForm] Updated fieldMedia:', newFieldMedia);
