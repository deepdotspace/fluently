...
interface WordListProps {
  ...
  onSelectWord: (word: VocabEntry) => void;
  onToggleSelect: (word: string | undefined) => void;
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              onMouseEnter={(e: MouseEvent<HTMLButtonElement>) => {
                (e.target as HTMLElement).style.background = theme.textSecondary + '15';
                (e.target as HTMLElement).style.borderColor = theme.textSecondary;
              }}
              onMouseLeave={(e: MouseEvent<HTMLButtonElement>) => {
                (e.target as HTMLElement).style.background = 'transparent';
                (e.target as HTMLElement).style.borderColor = theme.textSecondary + '40';
              }}
            >
              Clear
            </button>
          ...
          <button
            ...
            onMouseEnter={(e: MouseEvent<HTMLButtonElement>) => {
              ...
              (e.target as HTMLElement).style.boxShadow = `0 6px 16px ${theme.primary}40`;
            }}
            onMouseLeave={(e: MouseEvent<HTMLButtonElement>) => {
              (e.target as HTMLElement).style.transform = 'translateY(0)';
              (e.target as HTMLElement).style.boxShadow = `0 4px 12px ${theme.primary}30`;
            }}
          >
          ...
          words.map((word, index) => {
            ...
            return (
              <div
                ...
                onMouseEnter={() => setHoveredWord(word.word ?? null)}
