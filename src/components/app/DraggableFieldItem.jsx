      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
          <button
            ...
            onMouseEnter={(e) => {
              e.target.style.background = field.style && Object.keys(field.style).length > 0 ? `${theme.primary}30` : 'white';
              e.target.style.borderColor = theme.primary;
            }}
            onMouseLeave={(e) => {
              e.target.style.background = field.style && Object.keys(field.style).length > 0 ? `${theme.primary}20` : 'rgba(255, 255, 255, 0.6)';
              e.target.style.borderColor = field.style && Object.keys(field.style).length > 0 ? theme.primary : theme.cardBorder;
            }}
            title="Style field"
          >
