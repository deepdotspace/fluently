...
const HelpText = React.memo(({ text, show, theme }) => (
  <div style={{
...
function SettingsPanel({ settings, updateSettings, decks, deckMutations }) {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (deckDropdownRef.current && !deckDropdownRef.current.contains(event.target)) {
  ...
  const currentSettings = useMemo(() =>
    scope === 'global'
      ? settings?.global
      : (selectedDeckId && decks[selectedDeckId]?.settingsOverride) || settings?.global,
    ...
    if (scope === 'global') {
      ...
      if (deck?.recordId) {
        ...
        deckMutations.put(recordId, {
          ...deckData,
          settingsOverride: localSettings || currentSettings
        });
      }
  ...
  const parseSteps = useCallback((str) => {
    return str.split(',').map(s => s.trim()).filter(Boolean);
  }, []);

  const stepsToString = useCallback((arr) => {
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '20px' }}>
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('learningSteps', parseSteps(e.target.value))}
                  placeholder="1m, 10m"
                  theme={currentTheme}
                />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '16px' : '20px' }}>
                <div>
                  <InputField
                    ...
                    onChange={(e) => updateSetting('graduatingInterval', parseInt(e.target.value) || 0)}
                    theme={currentTheme}
                  />
                ...
                <div>
                  <InputField
                    ...
                    onChange={(e) => updateSetting('easyInterval', parseInt(e.target.value) || 0)}
                    theme={currentTheme}
                  />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '20px' }}>
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('relearningSteps', parseSteps(e.target.value))}
                  placeholder="10m"
                  theme={currentTheme}
                />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '16px' : '20px' }}>
                <div>
                  <InputField
                    ...
                    onChange={(e) => updateSetting('minimumInterval', parseInt(e.target.value) || 0)}
                    theme={currentTheme}
                  />
                ...
                <div>
                  <InputField
                    ...
                    onChange={(e) => updateSetting('leechThreshold', parseInt(e.target.value) || 0)}
                    theme={currentTheme}
                  />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '16px' : '20px' }}>
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('startingEase', parseFloat(e.target.value) || 0)}
                  theme={currentTheme}
                />
              ...
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('easyBonus', parseFloat(e.target.value) || 0)}
                  theme={currentTheme}
                />
              ...
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('hardInterval', parseFloat(e.target.value) || 0)}
                  theme={currentTheme}
                />
              ...
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('intervalModifier', parseFloat(e.target.value) || 0)}
                  theme={currentTheme}
                />
              ...
              <div>
                <InputField
                  ...
                  onChange={(e) => updateSetting('maximumInterval', parseInt(e.target.value) || 0)}
                  theme={currentTheme}
                />
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (localSettings) {
                  ...
                  e.target.style.boxShadow = `0 8px 28px ${currentTheme.primary}60`;
                }
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = localSettings ? `0 4px 20px ${currentTheme.primary}40` : 'none';
              }}
            >
