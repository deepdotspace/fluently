 ...
 * @param {string} intervalStr - Interval string in format "number + unit"
 ...
 */
function applyIntervalFuzz(interval) {
 ...
 * @param {number} lapses - Number of times card has been failed
 * @param {number} leechThreshold - Threshold for leech detection
 * @returns {boolean} True if card is a leech
 */
function isLeech(lapses, leechThreshold) {
 ...
 * 
 * @param {Object} card - Card object with scheduling property
 * @param {number} rating - User rating (1=Again, 2=Hard, 3=Good, 4=Easy)
 * @param {Object} settings - Settings object with global property
 * @returns {Object} Updated scheduling object
 */
export function calculateNextReview(card, rating, settings) {
  // Validate inputs
